...
pub(super) async fn list_pools_handler(
...
pub(super) async fn get_pool_handler(
    State(state): State<AppState>,
    Path(id): Path<Uuid>,
...
pub(super) async fn list_opening_suites_handler(
    State(state): State<AppState>,
...
pub(super) async fn get_opening_suite_handler(
    State(state): State<AppState>,
    Path(id): Path<Uuid>,
